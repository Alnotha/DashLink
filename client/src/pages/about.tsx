  ...
  return (
    <main className="container py-20">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">About Layan Tharani</h1>
        
        <Card className="mb-12">
          <CardContent className="pt-6">
            <p className="text-lg leading-relaxed mb-6">
              With years of experience in the convenience store and gas station industry,
              Layan Tharani understands the challenges that business owners face in 
        ...
        <div className="grid gap-6 mb-12">
          <Card>
            <CardContent className="pt-6">
              ...
              <p>
                We handle all aspects of your delivery platform presence, from initial 
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p>
                Our team is always available to address your concerns and ensure 
          ...
          <Card>
            <CardContent className="pt-6">
              ...
              <p>
                We're committed to helping your business grow by maximizing the 
